<?php
if(isset($_GET['r'])){
    header('Location: http://localhost/namu-darbai/mechanika/05-mechanika/red.php');
    die;
}
?>
<!DOCTYPE html>
...
<body style="background: blue;">
    ...
    <a href="http://localhost/namu-darbai/mechanika/05-mechanika/blue.php?r=1">I RAUDONA!!!</a>
</body>
</html>